...
export function normaliseHeroResponsive(input = {}, legacyHero = {}) {
  ...
  return Object.fromEntries(HERO_DEVICE_IDS.map(device => {
    ...
    return [device, {
      ...
      backgroundType: oneOf(source.backgroundType, ['inherit', 'image', 'video'], fallback.backgroundType),
      backgroundMedia: String(source.backgroundMedia || '').slice(0, 500),
      posterMedia: String(source.posterMedia || '').slice(0, 500),
